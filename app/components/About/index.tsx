  ...
  return (
    <SectionWrapper id='about' title='about'>
      <div className='flex flex-col xl:flex-row items-center xl:justify-between'>
        <div className='flex flex-col lg:flex-row xl:flex-col lg:gap-8 w-full xl:w-2/4'>
          <div className='flex flex-col gap-2 items-start w-full md:text-md'>
            <p className='text-2xl font-lato'>Hello! I'm Rafał,</p>
            <p className='w-full'>
              a self-taught developer passionate about crafting websites and
              applications. Over the past year, I've honed my skills in
              front-end development, focusing on technologies like React,
              Next.js, TypeScript.
            </p>
            ...
            <p className='w-full'>
              ...
              teamwork, contributing to two exciting ventures. Prior to my
              coding journey, I worked as a sales specialist in the electrical
              industry, serving wholesale clients.
            </p>
            <p className='w-full'>
